...
| mybatis-generator                   | compile | *.xml                                   | *.xml, *.java                                          | Mapper, Entity                   |
| jooq-codegen*                       | compile | database table                          | *.java                                                 | table, record/Entity, enum, pojo |
| swagger-codegen*                    | compile | *.json, \*.yml                          | *.java                                                 | rest client                      |
...
|        | Disruptor                       | JCTools                           | hppc                  | agrona                                                                      | ~~commons-primitives~~ |
|:-------|:--------------------------------|:----------------------------------|:----------------------|:----------------------------------------------------------------------------|:-----------------------|
| 许可证    | ASL                             | ASL                               | ASL                   | ASL                                                                         | ASL                    |
| 最近更新时间 | 2023                            | -                                 | 2021                  | -                                                                           | 2005                   |
| 数据结构   | ring buffer: lock-free, padding | SPSC/SPMC/MPSC/MPMC: padding, cas | primitive collections | primitive collections, ring buffer: lock less, SPSC/MPSC/MPMC: padding, cas | primitive collections  |
| 用户     | log4j2                          | netty                             | -                     | -                                                                           |                        |
