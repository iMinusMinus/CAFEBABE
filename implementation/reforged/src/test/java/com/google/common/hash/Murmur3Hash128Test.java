...
public class Murmur3Hash128Test /* extends TestCase */ {
    @Test public void testKnownValues() {
        ...
        Assertions.assertEquals("6c1b07bc7bbc4be347939ac4a93c437a", foxHash.toString());
    }
    ...
    private static void assertHash(int seed, long expected1, long expected2, String stringInput) {
        ...
        Assertions.assertEquals(expected, murmur3_128(seed).hashBytes(input));
        Assertions.assertEquals(expected, murmur3_128(seed).newHasher().putBytes(input).hash());
    }
