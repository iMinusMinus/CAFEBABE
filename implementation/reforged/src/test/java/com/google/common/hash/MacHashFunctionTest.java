...
//    @AndroidIncompatible // sun.security
    ...
    @Test public void testMultipleUpdatesDoFinal() throws Exception {
        Mac mac = Mac.getInstance("HmacSHA1");
        mac.init(SHA1_KEY);
        mac.update("hello".getBytes(UTF_8));
        mac.update("world".getBytes(UTF_8));
    ...
    @Test public void testCustomKey() throws Exception {
        SecretKey customKey =
                new SecretKey() {
                    @Override
    ...
    @Test public void testBadKey_emptyKey() throws Exception {
        SecretKey badKey =
                new SecretKey() {
                    @Override
                    public String getAlgorithm() {
    ...
    @Test public void testEmptyInputs() throws Exception {
        String knownOutput = "8cbf764cbe2e4623d99a41354adfd390";

        Mac mac = Mac.getInstance("HmacMD5");
        mac.init(MD5_KEY);
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal()).toString());
        Assertions.assertEquals(knownOutput, Hashing.hmacMd5(MD5_KEY).newHasher().hash().toString());
    }

    @Test public void testEmptyInputs_mixedAlgorithms() throws Exception {
        String knownOutput = "8cbf764cbe2e4623d99a41354adfd390";

        Mac mac = Mac.getInstance("HmacMD5");
        mac.init(SHA1_KEY);
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal()).toString());
        Assertions.assertEquals(knownOutput, Hashing.hmacMd5(SHA1_KEY).newHasher().hash().toString());
    }

    @Test public void testKnownInputs() throws Exception {
        ...
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal()).toString());
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal(input.getBytes(UTF_8))).toString());
        Assertions.assertEquals(knownOutput, Hashing.hmacMd5(MD5_KEY).hashString(input, UTF_8).toString());
        Assertions.assertEquals(knownOutput, Hashing.hmacMd5(MD5_KEY).hashBytes(input.getBytes(UTF_8)).toString());
    }

    @Test public void testKnownInputs_mixedAlgorithms() throws Exception {
        String knownOutput = "9753980fe94daa8ecaa82216519393a9";
        String input = "The quick brown fox jumps over the lazy dog";
        ...
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal()).toString());
        Assertions.assertEquals(knownOutput, HashCode.fromBytes(mac.doFinal(input.getBytes(UTF_8))).toString());
        Assertions.assertEquals(knownOutput, Hashing.hmacMd5(SHA1_KEY).hashString(input, UTF_8).toString());
        Assertions.assertEquals(
    ...
    @Test public void testPutAfterHash() {
        ...
        Assertions.assertThrows(IllegalStateException.class, () -> hasher.putInt(42));
    }
    ...
    @Test public void testHashTwice() {
        ...
        Assertions.assertEquals(
                "9753980fe94daa8ecaa82216519393a9",
                hasher.putString("The quick brown fox jumps over the lazy dog", UTF_8).hash().toString());
        Assertions.assertThrows(IllegalStateException.class, () -> hasher.hash());
    }
    ...
    private static void assertMacHashing(
        ...
        Assertions.assertEquals(HashCode.fromBytes(mac.doFinal()), hashFunc.hashBytes(input));
        Assertions.assertEquals(HashCode.fromBytes(mac.doFinal(input)), hashFunc.hashBytes(input));
    }

    // Tests from RFC2022: https://tools.ietf.org/html/rfc2202

    @Test public void testRfc2202_hmacSha1_case1() {
    ...
    @Test public void testRfc2202_hmacSha1_case2() {
    ...
    @Test public void testRfc2202_hmacSha1_case3() {
...
//    }
    ...
    @Test public void testRfc2202_hmacSha1_case5() {
    ...
    @Test public void testRfc2202_hmacSha1_case6() {
    ...
    @Test public void testRfc2202_hmacSha1_case7() {
        byte[] key = fillByteArray(80, 0xaa);
    ...
    @Test public void testRfc2202_hmacMd5_case1() {
    ...
    @Test public void testRfc2202_hmacMd5_case2() {
        byte[] key = "Jefe".getBytes(UTF_8);
        String data = "what do ya want for nothing?";
    ...
    @Test public void testRfc2202_hmacMd5_case3() {
...
//    }
    ...
    @Test public void testRfc2202_hmacMd5_case5() {
    ...
    @Test public void testRfc2202_hmacMd5_case6() {
        byte[] key = fillByteArray(80, 0xaa);
        String data = "Test Using Larger Than Block-Size Key - Hash Key First";
    ...
    @Test public void testRfc2202_hmacMd5_case7() {
        byte[] key = fillByteArray(80, 0xaa);
        String data = "Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data";
    ...
    private static void checkHmac(String expected, HashFunction hashFunc, byte[] data) {
        Assertions.assertEquals(HashCode.fromString(expected), hashFunc.hashBytes(data));
    }
