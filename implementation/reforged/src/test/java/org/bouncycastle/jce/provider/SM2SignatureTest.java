...
//        extends SimpleTest
{
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < times; i++)
        {
            ...
            Assertions.assertEquals(rs[0], new BigInteger("40F1EC59F793D9F49E09DCEF49130D4194F79FB1EED2CAA55BACDB49C4E755D1", 16), "r wrong");
            Assertions.assertEquals(rs[1], new BigInteger("6FC6DAC32C5D5CF10C77DFB20F7C2EB667A457872FB09EC56327A67EC7DEEBE7", 16), "s wrong");

            verifier.update(msg, 0, msg.length);

            Assertions.assertTrue(verifier.verify(sig), "verification failed i=" + i);
        }
    }
