...
//        extends SimpleTest
{
            ...
            throws Exception
    {
        ...
        Assertions.assertArrayEquals(Hex.decode(
                "04245C26 FB68B1DD DDB12C4B 6BF9F2B6 D5FE60A3 83B0D18D 1C4144AB F17F6252" +
                        ...
                        "76712DA9 D8094A63 4B766D3A 285E0748 0653426D"), enc, "enc wrong");

        sm2Engine.init(Cipher.DECRYPT_MODE, aKp.getPrivate());

        byte[] dec = sm2Engine.doFinal(enc);

        Assertions.assertArrayEquals(m, dec, "dec wrong");
            ...
            throws Exception
    {
        ...
        Assertions.assertTrue(enc.length == sm2Engine1.getOutputSize(m.length));
