...
public class SM2Engine
{
    ...
    public void init(boolean forEncryption, CipherParameters param)
    {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties("SM2", ConstraintUtils.bitsOfSecurityFor(ecParams.getCurve()), ecKey, forEncryption ? CryptoServicePurpose.ENCRYPTION : CryptoServicePurpose.DECRYPTION));
    }
    ...
    private BigInteger nextK()
    {
        ...
        while (k.equals(BigInteger.ZERO) || k.compareTo(ecParams.getN()) >= 0);
