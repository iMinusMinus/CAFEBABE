    ...
    implements ExtendedDigest
{
    ...
    public Blake2sDigest(Blake2sDigest digest)
    {
        ...
        this.buffer = digest.buffer == null ? null : digest.buffer.clone();
        this.keyLength = digest.keyLength;
        this.key = digest.key == null ? null : digest.key.clone();
        this.digestLength = digest.digestLength;
        this.internalState = digest.internalState == null ? null : digest.internalState.clone();
        this.chainValue = digest.chainValue == null ? null : digest.chainValue.clone();
        this.t0 = digest.t0;
        this.t1 = digest.t1;
        this.f0 = digest.f0;
        this.salt = digest.salt == null ? null : digest.salt.clone();
        this.personalization = digest.personalization == null ? null : digest.personalization.clone();
    ...
    private void G(int m1, int m2, int posA, int posB, int posC, int posD)
    {
        ...
        internalState[posD] = Integer.rotateRight(internalState[posD] ^ internalState[posA], 16);
        internalState[posC] = internalState[posC] + internalState[posD];
        internalState[posB] = Integer.rotateRight(internalState[posB] ^ internalState[posC], 12);
        internalState[posA] = internalState[posA] + internalState[posB] + m2;
        internalState[posD] = Integer.rotateRight(internalState[posD] ^ internalState[posA], 8);
        internalState[posC] = internalState[posC] + internalState[posD];
        internalState[posB] = Integer.rotateRight(internalState[posB] ^ internalState[posC], 7);
    }
