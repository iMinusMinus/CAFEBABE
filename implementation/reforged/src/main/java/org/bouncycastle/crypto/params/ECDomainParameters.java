...
//    implements ECConstants
{
        ...
        byte[]      seed)
    {
        ...
        this.n = n;
        this.h = h;
        this.seed = seed == null ? null : seed.clone(); // Arrays.clone(seed);
    }
    ...
    public byte[] getSeed()
    {
        return seed == null ? null : seed.clone(); // Arrays.clone(seed);
    }
...
//        return Arrays.hashCode(new Object[]{ curve, G, n });
    ...
    public BigInteger validatePrivateScalar(BigInteger d)
    {
        ...
        if (d.compareTo(BigInteger.ONE) < 0  || (d.compareTo(getN()) >= 0))
        {
