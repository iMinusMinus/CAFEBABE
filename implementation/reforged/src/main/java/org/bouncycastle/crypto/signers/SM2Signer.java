    ...
    implements Signer//, ECConstants
{
    ...
    public void init(boolean forSigning, CipherParameters param)
    {
        ...
        if (forSigning)
        {
            ...
            BigInteger nSub1 = ecParams.getN().subtract(BigInteger.ONE);

            if (d.compareTo(BigInteger.ONE) < 0  || d.compareTo(nSub1) >= 0)
            {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties("ECNR",  ConstraintUtils.bitsOfSecurityFor(ecKey.getParameters().getCurve()), forSigning));
        ...
        throws CryptoException
    {
        ...
        do // generate s
        {
            ...
            // A6
            BigInteger dPlus1ModN = BigIntegers.modOddInverse(n, d.add(BigInteger.ONE));
