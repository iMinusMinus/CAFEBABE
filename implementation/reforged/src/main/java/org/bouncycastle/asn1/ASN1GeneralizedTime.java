    ...
    extends ASN1Primitive
{
    ...
    public ASN1GeneralizedTime(
        Date time)
    {
        SimpleDateFormat dateF = new SimpleDateFormat("yyyyMMddHHmmss'Z'", Locale.ENGLISH);
        ...
        throws ParseException
    {
        ...
        if (stime.endsWith("Z"))
        {
            if (hasFractionalSeconds())
            {
                dateF = new SimpleDateFormat("yyyyMMddHHmmss.SSS'Z'", Locale.ENGLISH);
            }
            else if (hasSeconds())
            {
                dateF = new SimpleDateFormat("yyyyMMddHHmmss'Z'", Locale.ENGLISH);
            }
            else if (hasMinutes())
            {
                dateF = new SimpleDateFormat("yyyyMMddHHmm'Z'", Locale.ENGLISH);
            }
            else
            {
                dateF = new SimpleDateFormat("yyyyMMddHH'Z'", Locale.ENGLISH);
            }
