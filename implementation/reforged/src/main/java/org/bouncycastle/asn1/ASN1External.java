    ...
    extends ASN1Primitive
{
    ...
    boolean asn1Equals(ASN1Primitive primitive)
    {
        ...
        return Objects.equals(this.directReference, that.directReference)
            && Objects.equals(this.indirectReference, that.indirectReference)
            && Objects.equals(this.dataValueDescriptor, that.dataValueDescriptor)
