    ...
    extends ASN1Primitive
{
    ...
    public ASN1UTCTime(
        Date time)
    {
        SimpleDateFormat dateF = new SimpleDateFormat("yyMMddHHmmss'Z'", Locale.ENGLISH);
    ...
    {
        SimpleDateFormat dateF = new SimpleDateFormat("yyMMddHHmmssz", Locale.ENGLISH);
    ...
    public Date getAdjustedDate()
        throws ParseException
    {
        SimpleDateFormat dateF = new SimpleDateFormat("yyyyMMddHHmmssz", Locale.ENGLISH);
