...
class Tnaf
{
    ...
    private static final BigInteger MINUS_TWO = BigInteger.valueOf(2L).negate();
    private static final BigInteger MINUS_THREE = BigInteger.valueOf(3L).negate();
    ...
    public static final ZTauElement[] alpha0 =
    {
        ...
        null, new ZTauElement(BigInteger.ONE, MINUS_ONE),
        null, new ZTauElement(MINUS_ONE, BigInteger.ONE),
        null, new ZTauElement(BigInteger.ONE, BigInteger.ONE),
        null, new ZTauElement(BigInteger.valueOf(3L), BigInteger.ONE),
        null, new ZTauElement(MINUS_ONE, BigInteger.ZERO),
    };
    ...
    {
        null, new ZTauElement(BigInteger.ONE, BigInteger.ZERO),
        null, new ZTauElement(MINUS_THREE, BigInteger.ONE),
        null, new ZTauElement(MINUS_ONE, BigInteger.ONE),
        null, new ZTauElement(BigInteger.ONE, BigInteger.ONE),
        null, new ZTauElement(MINUS_ONE, MINUS_ONE),
        null, new ZTauElement(BigInteger.ONE, MINUS_ONE),
        null, new ZTauElement(BigInteger.valueOf(3L), MINUS_ONE),
        null, new ZTauElement(MINUS_ONE, BigInteger.ZERO),
    };
...
//            return s1.subtract(s2).add(s3);
            ...
            SimpleBigDecimal lambda1, byte mu)
    {
        ...
        {
            // eta < 1
            if (check2.compareTo(BigInteger.valueOf(2L)) >= 0)
            {
                h1 = mu;
            }
        }
    ...
    public static byte[] tauAdicNaf(byte mu, ZTauElement lambda)
    {
        ...
        while(!((r0.equals(BigInteger.ZERO)) && (r1.equals(BigInteger.ZERO))))
        {
            ...
            if (r0.testBit(0))
            {
                u[i] = (byte) BigInteger.valueOf(2L).subtract((r0.subtract(r1.shiftLeft(1))).mod(BigInteger.valueOf(4L))).intValue();
    ...
    protected static int getShiftsForCofactor(BigInteger h)
    {
        if (h != null)
        {
            if (h.equals(BigInteger.valueOf(2L)))
            {
                return 1;
            }
            if (h.equals(BigInteger.valueOf(4L)))
            {
                return 2;
            }
        }
    ...
    public static ZTauElement partModReduction(ECCurve.AbstractF2m curve, BigInteger k, byte a, byte mu, byte c)
    {
        ...
        if (curve.isKoblitz())
        {
             ...
             */
            vm = BigInteger.ONE.shiftLeft(m).add(BigInteger.ONE).subtract(
    ...
    */
    ...
    public static byte[] tauAdicWNaf(byte mu, ZTauElement lambda, int width, int tw, ZTauElement[] alpha)
    {
        ...
        long r0_64 = R0.longValueExact(); // BigIntegers.longValueExact(R0);
        long r1_64 = R1.longValueExact(); // BigIntegers.longValueExact(R1);
