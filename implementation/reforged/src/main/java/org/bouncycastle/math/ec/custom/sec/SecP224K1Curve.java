...
public class SecP224K1Curve extends ECCurve.AbstractFp
{
    ...
    private static final ECFieldElement[] SECP224K1_AFFINE_ZS = new ECFieldElement[] { new SecP224K1FieldElement(BigInteger.ONE) };
    ...
    public SecP224K1Curve()
    {
        ...
        this.a = fromBigInteger(BigInteger.ZERO);
