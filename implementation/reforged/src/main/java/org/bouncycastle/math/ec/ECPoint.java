...
public abstract class ECPoint
{
    ...
    {
        if (BigInteger.ONE.equals(curve.getCofactor()))
        {
            return true;
        }
...
//                ECFieldElement Z3 = doubleProductFromSquares(Y1, Z1, Y1Squared, Z1Squared);
        ...
        public ECPoint timesPow2(int e)
        {
            ...
            ECFieldElement X1 = this.x;
            ECFieldElement Z1 = this.zs.length < 1 ? curve.fromBigInteger(BigInteger.ONE) : this.zs[0];
    ...
    public static abstract class AbstractF2m extends ECPoint
    {
        ...
        protected boolean satisfiesOrder()
        {
            ...
            if (BigInteger.valueOf(2L).equals(cofactor))
            {
                /*
