...
public abstract class ECCurve
{
    ...
    public int hashCode() 
    {
        return getField().hashCode()
            ^ Integer.rotateLeft(getA().toBigInteger().hashCode(), 8)
            ^ Integer.rotateLeft(getB().toBigInteger().hashCode(), 16);
    }
...
//                }
        ...
        protected ECFieldElement solveQuadraticEquation(ECFieldElement beta)
        {
            ...
            ECFieldElement gamma, z, zeroElement = this.fromBigInteger(BigInteger.ZERO);
