...
//                d > 0, "The number of SipRound iterations (d=%s) during Finalization must be positive.", d);
        if (c <= 0) {
            throw new IllegalArgumentException(String.format("The number of SipRound iterations (c=%s) during Compression must be positive.", c));
        }
        if (d <= 0) {
            throw new IllegalArgumentException(String.format("The number of SipRound iterations (c=%s) during Finalization must be positive.", d));
        }
        this.c = c;
        this.d = d;
        this.k0 = k0;
