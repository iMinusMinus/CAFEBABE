...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        protected void processRemaining(ByteBuffer bb) {
            ...
            switch (bb.remaining()) {
                case 15:
                    k2 ^= (long) (bb.get(14) & 0xFF) << 48; // fall through
                case 14:
                    k2 ^= (long) (bb.get(13) & 0xFF) << 40; // fall through
                case 13:
                    k2 ^= (long) (bb.get(12) & 0xFF) << 32; // fall through
                case 12:
                    k2 ^= (long) (bb.get(11) & 0xFF) << 24; // fall through
                case 11:
                    k2 ^= (long) (bb.get(10) & 0xFF) << 16; // fall through
                case 10:
                    k2 ^= (long) (bb.get(9) & 0xFF) << 8; // fall through
                case 9:
                    k2 ^= (long) (bb.get(8) & 0xFF); // fall through
                case 8:
                    k1 ^= bb.getLong();
                    break;
                case 7:
                    k1 ^= (long) (bb.get(6) & 0xFF) << 48; // fall through
                case 6:
                    k1 ^= (long) (bb.get(5) & 0xFF) << 40; // fall through
                case 5:
                    k1 ^= (long) (bb.get(4) & 0xFF) << 32; // fall through
                case 4:
                    k1 ^= (long) (bb.get(3) & 0xFF) << 24; // fall through
                case 3:
                    k1 ^= (long) (bb.get(2) & 0xFF) << 16; // fall through
                case 2:
                    k1 ^= (long) (bb.get(1) & 0xFF) << 8; // fall through
                case 1:
