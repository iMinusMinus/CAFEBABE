...
public final class Funnels {
    ...
    private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
        ...
        StringCharsetFunnel(Charset charset) {
            this.charset = Objects.requireNonNull(charset); // Preconditions.checkNotNull(charset);
        }
    ...
    private static class SequentialFunnel<E extends /* @Nullable */ Object>
        ...
        SequentialFunnel(Funnel<E> elementFunnel) {
            this.elementFunnel = Objects.requireNonNull(elementFunnel); // Preconditions.checkNotNull(elementFunnel);
        }
    ...
    private static class SinkAsStream extends OutputStream {
        ...
        SinkAsStream(PrimitiveSink sink) {
            this.sink = Objects.requireNonNull(sink); // Preconditions.checkNotNull(sink);
        }
